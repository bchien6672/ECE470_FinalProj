...
def main():
    ...
    if frame_selection == 1:
        body_theta = perform_IK(desired_T, M, S, 3, frame_selection, Larm_joints, Rarm_joints, body_joints, joint_bodynames, joint_Rarm, joint_Larm, clientID)
        print "The final thetas are", body_theta
    elif frame_selection == 2:
        Larm_theta = perform_IK(desired_T, M, S, 7, frame_selection, Larm_joints, Rarm_joints, body_joints, joint_bodynames, joint_Rarm, joint_Larm, clientID)
        print "The final thetas are", Larm_theta
    elif frame_selection == 3:
        Rarm_theta = perform_IK(desired_T, M, S, 7, frame_selection, Larm_joints, Rarm_joints, body_joints, joint_bodynames, joint_Rarm, joint_Larm, clientID)
        print "The final thetas are", Rarm_theta
    else:
        print "I don't know how you could get this far without getting an error....."
